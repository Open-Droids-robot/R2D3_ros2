...
| 09 | `09_kitchen_clear_island.py` | **ML perception** — OWL-ViT locates the mug in the head cam, the robot picks + places it | needs `pip install transformers`; writes a GIF + detection frame |
